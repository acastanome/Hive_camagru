		...
		<!-- <input accept="image/*" type="file" class="dropbtn" id="upload_photo" name="upload"> -->
			...
			<div class="camera_container">
				...
				<form class="camera_form" name="cameraPostForm" action="camera_create_post.php" method="POST" enctype='multipart/form-data'>
						...
						<!-- id=upload_photo, name=upload -->
						<!-- <input type="hidden" name="upload_file" id="upload_file" value=<script type="text/javascript">document.getElementById("upload_photo")</script>> -->

						<input accept="image/*" type="file" class="dropbtn" id="image_input" name="image_input">
						<img type="hidden" id="uploaded-picture" src="">
						<!-- <br><img type="hidden" id="myImg" src=""> -->
						<!-- <br><img type="hidden" name="myImg_file" id="myImg_file" src=""> -->
