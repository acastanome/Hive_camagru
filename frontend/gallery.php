							...
							<div class="left">
								<?php if ($userliked != 0) { ?>
									...
									onclick="ajaxLike(<?php echo($image['img_id']);?>)">
										<img id="heart<?php echo($image['img_id']);?>" name="outline" src="http://localhost:8080/camagru/media/heart-full.png"
											alt="heart">
									</span>
								<?php
								} else {
								?>
									<span class="heart"
									onclick="ajaxLike(<?php echo($image['img_id']);?>)">
									<img id="heart<?php echo($image['img_id']);?>" name="full" src="http://localhost:8080/camagru/media/heart-outline.png"
											alt="heart">
									</span>
								<?php
								}
								...
								<?php if ($usercommented != 0) { ?>
									<span class="comment">
										<img id="comment<?php echo($image['img_id']);?>" name="fullC" src="http://localhost:8080/camagru/media/comment-full.png"
											alt="comment">
									</span>
								<?php
								} else {
								?>
									<span class="comment">
									<img id="comment<?php echo($image['img_id']);?>" name="outlineC" src="http://localhost:8080/camagru/media/comment-outline.png"
											alt="comment">
									</span>
								<?php
								}
